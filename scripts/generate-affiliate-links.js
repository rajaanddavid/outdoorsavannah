...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    function showFallbackButton(deeplink_android, targetLink) {
        ...
        topText.style.cssText = "position: absolute; top: 35%; font-size: 20px; opacity: 0.9;";

        const bottomText = document.createElement('div');
        bottomText.textContent = 'or tap anywhere';
        bottomText.style.cssText = "position: absolute; bottom: 35%; font-size: 18px; opacity: 0.8;";
