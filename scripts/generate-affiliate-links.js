...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    function showFallbackButton(deeplink_android, targetLink) {
        ...
        overlay.style.cssText = "position: fixed; inset: 0; background: rgba(0,0,0,0.85); color: white; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; font-size: 18px; font-weight: 500; z-index: 999999; cursor: pointer;";

        // Top text
        const topText = document.createElement('div');
        topText.textContent = 'Redirecting...';
        topText.style.cssText = "margin-bottom: 16px; font-size: 18px; opacity: 0.9;";

        // Bottom text
        const bottomText = document.createElement('div');
        bottomText.textContent = 'or tap anywhere';
        bottomText.style.cssText = "margin-top: 16px; font-size: 16px; opacity: 0.8;";
