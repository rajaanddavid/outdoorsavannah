...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    function showFallbackButton(deeplink_android, targetLink) {
        ...
        overlay.style.cssText = "position:fixed;inset:0;background:rgba(0,0,0,0.8);color:white;display:flex;align-items:center;justify-content:center;font-size:18px;font-weight:500;text-align:center;z-index:999999;cursor:pointer;";
        overlay.textContent = 'Redirecting... or anywhere tap to continue';
